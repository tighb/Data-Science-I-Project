...
# TODO
```
Each observation is a numerical value.  It is associated with the year it was recorded and the country  of origin.
...
ggplot(labor_data, aes(x = gdp)) +
  geom_histogram(fill = "white",
                 ...
                 binwidth = 500) +
  xlim(0, 75000)
#TODO: fix the gg plot above for GDP or simply use the simple plot below
hist(labor_data$gdp)
...
```
# TODO write on these
The CPI data are right skewed and trimodal.  GDP is heavily right-skewed. Unemployment is an approximately  normal distribution with a right skew.
...
All the data have a geospatial and temporal component: they reflect economic indicators for particular countries during specific years.

CPI reflects changes in the price of a fixed assortment of household goods, providing a representation for adjustments in the costs associated with running a household.
...
#TODO:  Are the countries the observations or is the yearly data?
What information/features/characteristics do you have for each observation?
